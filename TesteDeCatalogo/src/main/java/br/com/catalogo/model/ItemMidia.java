...
public class ItemMidia implements Serializable {
    ...
    private String tipoMidia; // Ex: Filme, Série, Livro, Música

    // Construtor padrão
    public ItemMidia() {
    }

    // Construtor completo (sem ID, para cadastro)
    ...
    // Construtor completo (com ID, para edição/leitura)
    public ItemMidia(Long id, String titulo, String autorDiretor, Integer anoLancamento, String genero, String sinopse, String tipoMidia) {
        this.id = id;
        this.titulo = titulo;
        this.autorDiretor = autorDiretor;
        this.anoLancamento = anoLancamento;
    ...
    public String toString() {
        return "ItemMidia [id=" + id + ", titulo=" + titulo + ", tipoMidia=" + tipoMidia + "]";
    }
}
